...
###################################
  ...
  RUN cd /
  RUN curl --netrc-file /home/jenkins/.netrc ftp://yifileserver/DOCKER_IMAGES/Tensorflow/Tensorflow-1.8.0-9.0-cudnn7-devel-ubuntu16.04-Server_19.20/tensorflow-1.8.0-cp36-cp36m-linux_x86_64.whl -o tensorflow-1.8.0-cp36-cp36m-linux_x86_64.whl && \
